...
# обход прав на уровне проектов. Финансовую аналитику вправе видеть только
# руководство — CFO и CEO.
_PRIVILEGED_ROLES = {"ceo", "cfo"}
...
_ACCESS_DENIED_MESSAGE = (
    ...
    "согласования) доступна только руководству — CFO и CEO. "
...
def is_authorized(actor_role: Optional[str]) -> bool:
    ...
    Доступ имеют только привилегированные роли (CFO/CEO). Неопознанные
    пользователи (``actor_role is None`` — например, не заведены в системе)
    и рядовые сотрудники доступа не получают.
    """
